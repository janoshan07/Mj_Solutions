          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <div className="mt-8 space-y-4">
                ...
                <ContactItem icon={MapPin} title="Location" text="Colombo, Sri Lanka" />
              </div>
            </div>
...
function ContactItem({ icon: Icon, title, text }) {
  return (
    <div className="group flex gap-4 rounded-lg border border-cyan-400/20 bg-slate-950/75 p-5 shadow-[0_0_28px_rgba(34,211,238,0.07)] backdrop-blur transition hover:-translate-y-1 hover:border-brand-primary hover:shadow-[0_0_30px_rgba(34,211,238,0.18)]">
